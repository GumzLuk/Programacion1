...
type
  TForm1 = class(TForm)
    ...
    CargarPalabrasEnMatriz1: TMenuItem;
    ...
    procedure CargarPalabrasEnMatriz1Click(Sender: TObject);
  private
...
procedure TForm1.CargarPalabrasEnMatriz1Click(Sender: TObject);
var
 palabras : String;
begin
 palabras := InputBox('','Palabras : ','');
 MatrizN.CargarPalabrasEnMatriz(palabras);
end;
