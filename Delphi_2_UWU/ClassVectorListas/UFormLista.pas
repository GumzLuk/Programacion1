...
type
  TForm1 = class(TForm)
    ...
    promedioEstudiante1: TMenuItem;
    procedure FormCreate(Sender: TObject);
    procedure Button1Click(Sender: TObject);
    procedure Button2Click(Sender: TObject);
    procedure promedioEstudiante1Click(Sender: TObject);
  private
...
begin
 ...
 vectNotas.modElement(vectNotas.getDimension,ListaNot);
 MostrarEnPantalla;
end;
...
procedure TForm1.promedioEstudiante1Click(Sender: TObject);
 var
  registro : Cardinal;
begin
 registro := StrToInt(InputBox('Nro DE REGISTRO','Ingrese el registro : ',''));
 ShowMessage(FloatToStr(vectNotas.promedioEstudiante(registro)));
end;
